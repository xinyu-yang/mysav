...
|prefix (bit<32>, int)| asn(bit<32>) | port (bit<9>) | dstAddr(bit<48>)| flags(bit<8>) |
|---------------|-------------|--------------|------------|-----------|
|22.22.0.0/16   |    2         | 1         |    08:00:00:00:05:02|3|
|33.33.0.0/16   |  3          |    2         | 08:00:00:00:06:02| 3 |
|11.11.0.0/16   |  1           | 1           |08:00:00:00:05:02 | 5 |
...
|prefix (bit<32>, int)| asn(bit<32>) | port (bit<9>) | dstAddr(bit<48>)| flags(bit<8>) |
|---------------|-------------|--------------|------------|-----------|
|22.22.0.0/16   |    2         | 1         |    08:00:00:00:06:01| 1 |
|33.33.0.0/16   |  3          |    2         | 08:00:00:00:03:01| 3 |
|11.11.0.0/16   |  1           | 1           |08:00:00:00:06:01 | 5 |
...
|---------------|-------------|--------------|------------|-----------|
|22.22.0.0/16   |    2         | 1         |    08:00:00:00:06:01| 1 |
|33.33.0.0/16   |  3          |    2         | 08:00:00:00:06:02| 1 |
|11.11.0.0/16   |  1           | 1           |08:00:00:00:06:01 | 5 |
|55.55.0.0/16   |  5          |    1          |  08:00:00:00:06:01| 0 |
